...
All ground truth masks were generated by [[SAM](https://segment-anything.com/)] prompted by the [[D-Fire](https://github.com/gaiasd/DFireDataset)] dataset's bounding boxes. The resulting predictions along with a metrics diagram follows to showcase the model's performance.
